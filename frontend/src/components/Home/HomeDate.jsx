export default function ImportantDatesModern() {
    const events = [
      { date: "Dec. 1, 2025", title: "Full Paper Submission Deadline" },
      { date: "Dec. 2, 2025", title: "Acceptance Notification Deadline" },
      { date: "Dec. 3, 2025", title: "Final Paper Submission Deadline" },
      { date: "Dec. 4, 2025", title: "Conference Registration Deadline" },
    ];
          ...
          {events.map((event, index) => (
            <div key={index} className="relative group w-1/4 flex flex-col items-center text-center z-10">
              ...
              <div className="mt-4 bg-white border shadow-xl rounded-xl px-6 py-4 transition-all duration-300 group-hover:-translate-y-3 group-hover:scale-105">
                <p className="text-lg font-bold text-neutral-800">{event.date}</p>
